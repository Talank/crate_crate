...
public class PGTypes {
    ...
    private static final Map<DataType<?>, PGType<?>> CRATE_TO_PG_TYPES = MapBuilder.<DataType<?>, PGType<?>>newLinkedHashMapBuilder()
        ...
        // byte also maps to int2, it must come after short to keep the pg type -> short mapping that is first established.
        ...
        // byte array also maps to _int2, it must come after short array to keep the pg type -> short array mapping that is first established.
